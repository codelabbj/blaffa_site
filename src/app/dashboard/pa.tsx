...
// import { ArrowUpRight, ArrowDownLeft, RotateCw, Bell, User, ChevronRight } from 'lucide-react';
...
//             <p className="text-sm">Hello, <span className="text-red-500 font-medium">rash boy</span>!</p>
//           </div>
//         </div>
...
//         <h1 className="text-2xl font-bold mb-6">Welcome to LamedCash</h1>
        
//         {/* Action Buttons */}
//         <div className="flex gap-4 mb-8">
//           <button className="group flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 w-40">
//             DEPOSIT
//             <ArrowDownLeft size={16} className="transition-transform group-hover:translate-y-1" />
//           </button>
//           <button className="group flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 w-40 border border-gray-700">
//             WITHDRAW
...
//               <RotateCw size={16} className="text-gray-400 cursor-pointer hover:text-white transition-colors" />
//             </div>
...
//               <div key={transaction.id} className="flex items-center justify-between p-4 rounded-lg bg-gray-800 hover:bg-gray-750 transition-colors">
//                 <div className="flex items-center gap-4">
//                   <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${transaction.type === 'deposit' ? 'bg-red-500/20 text-red-500' : 'bg-gray-700/50 text-gray-300'}`}>
//                     {transaction.type === 'deposit' ? <ArrowDownLeft size={20} /> : <ArrowUpRight size={20} />}
//                   </div>
//                   <div>
//                     <p className="text-sm font-medium uppercase">{transaction.type} || {transaction.id.substring(0, 20)}{transaction.id.length > 20 ? '...' : ''} || {transaction.amount}</p>
//                     <p className="text-xs text-gray-400">{transaction.date} {transaction.time}</p>
//                   </div>
//                 </div>
//                 <div className="flex items-center">
//                   <span className={`text-sm font-medium ${transaction.status === 'pending' ? 'text-amber-500' : transaction.status === 'completed' ? 'text-green-500' : 'text-red-500'}`}>
...
//             <button className="group flex items-center gap-1 text-sm text-gray-400 hover:text-white transition-colors py-2 px-4 rounded-lg bg-gray-800 hover:bg-gray-700">
//               See more
