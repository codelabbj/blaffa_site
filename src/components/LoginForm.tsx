...
const GOOGLE_WEB_CLIENT_ID = '827338495555-adln59679pmgnetf452dtkj7dqa1263k.apps.googleusercontent.com';
...
export default function LoginForm() {
    ...
    // Google OAuth via redirection classique (plus fiable que GSI One Tap)
        ...
        <div className="w-full max-w-md mx-auto p-4 sm:p-6 bg-transparent">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3.5 rounded-xl transition-all duration-300 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                    {isGoogleLoading ? (
