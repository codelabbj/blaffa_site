    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WebSocketProvider.useEffect": ()=>{
            ...
            const handleStorageChange = {
                "WebSocketProvider.useEffect.handleStorageChange": (e)=>{
            ...
            }["WebSocketProvider.useEffect.handleStorageChange"];
            window.addEventListener('storage', handleStorageChange);
            // Periodic check for connection (pulse)
            const interval = setInterval({
                "WebSocketProvider.useEffect.interval": ()=>{
                    if (!ws.current || ws.current.readyState === WebSocket.CLOSED) {
                        const token = localStorage.getItem('accessToken');
                        if (token) connect();
                    }
                }
            }["WebSocketProvider.useEffect.interval"], 10000);
            return ({
                "WebSocketProvider.useEffect": ()=>{
...
_s(WebSocketProvider, "mVjzxxM5XT9ug7hf0z4geULj4MY=");
