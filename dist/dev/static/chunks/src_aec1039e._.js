...
function EditProfile() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditProfile.useEffect": ()=>{
            ...
            const fetchData = {
                "EditProfile.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        setFormData({
                            "EditProfile.useEffect.fetchData": (prev)=>({
                                    ...prev,
                        ...
                        }["EditProfile.useEffect.fetchData"]);
                    } catch (error) {
    ...
    const handleUpdateDetails = async (e)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/auth/edit`, {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(t('An unexpected error occurred while updating details.'));
        }
    };
...
_s(EditProfile, "R1OR88XHh2VhibCROEsCPch0j3g=", false, function() {
    return [
...
//# sourceMappingURL=src_aec1039e._.js.map