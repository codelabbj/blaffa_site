...
function Withdraw() {
            ...
            const fetchData = {
                "Withdraw.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        ...
                        if (token) {
                            promises.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/blaffa/network-v2/?type=withdrawal', {
                                headers: {
                                    Authorization: `Bearer ${token}`
                                }
                            }).then({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Withdraw.useEffect": ()=>{
            ...
            }["Withdraw.useEffect.timer"], 1000);
            return ({
                "Withdraw.useEffect": ()=>clearInterval(timer)
            })["Withdraw.useEffect"];
        }
    }["Withdraw.useEffect"], [
        timeLeft
...
_s(Withdraw, "2L5u6WmZPS+dqRwnHIYNfJBvvz8=", false, function() {
    return [
