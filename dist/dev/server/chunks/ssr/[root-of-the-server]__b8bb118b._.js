...
"[project]/src/app/profile/security/password/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ChangePassword() {
    ...
    const handleUpdatePassword = async (e)=>{
        ...
        if (formData.newPassword !== formData.confirmPassword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(t('Passwords do not match'));
            return;
        }
        if (formData.newPassword.length < 8) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(t('Password must be at least 8 characters long'));
            return;
        }
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/auth/set_password`, {
                current_password: formData.currentPassword,
                new_password: formData.newPassword,
                re_new_password: formData.confirmPassword
            });
            if (response.status === 204 || response.status === 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(t('Password updated successfully!'));
                router.push('/profile');
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8bb118b._.js.map